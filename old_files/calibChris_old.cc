...
void drawGausFit(TH2F* inHisto, TGraph& response, TGraph& resolution)
{
   ...
   {
     double x_min = -0.5, x_max = 1.0;
     if(strcmp(inHisto->GetName(),"corrEtaEndcapEcalHcal") == 0 && strcmp(_region_,"EC_outside_tracker") == 0)
       x_min = -0.70;
      name = "histcorhybrid";
      sprintf(num, "%i", bin);
      name += num;
...
void drawEtaDependence(TH2F* inHisto, TGraph& responseEta)
{
   ...
   TFile* file3=new TFile("output1.root","recreate");
   file3->cd();

   responseEta = TGraph(etaAverage.size(), &etaAverage[1], &gausMean[1]); 
...
void calibChris() 
{
   ...
   // chain->Add("./PGun_2_500_10_0_2_upgrade2018_NO_CUT_new.root");
   ...
   */
   ...
   if(freezeparameters) {
     ...
     //faEndcap
     //spandey
     functionEndcapEcalHcalB->FixParameter(0,1.13733);	
     functionEndcapEcalHcalB->FixParameter(1,18.9063);
     functionEndcapEcalHcalB->FixParameter(2,-43.4288);
     functionEndcapEcalHcalB->FixParameter(3,0.613362);
     functionEndcapEcalHcalB->FixParameter(4,-0.0473721);
     functionEndcapEcalHcalB->FixParameter(5,1.58942e-18);
     functionEndcapEcalHcalB->FixParameter(6,0.198447);
     functionEndcapEcalHcalB->FixParameter(7,-11.0499);
     ...
     //fbEndcap
     functionEndcapEcalHcalC->FixParameter(0,-0.814798);
     functionEndcapEcalHcalC->FixParameter(1,1.45713);
     functionEndcapEcalHcalC->FixParameter(2,0.122849);
     functionEndcapEcalHcalC->FixParameter(3,6.54898);
     functionEndcapEcalHcalC->FixParameter(4,-0.77984);
     functionEndcapEcalHcalC->FixParameter(5,6.36924e-05);
     functionEndcapEcalHcalC->FixParameter(6,0.134209);
     functionEndcapEcalHcalC->FixParameter(7,-4.32494);
   ...
   if(freezeparameters) {
     ...
     functionEndcapAlphaEcalHcal->FixParameter(0,-0.000395405);
     functionEndcapAlphaEcalHcal->FixParameter(1,11.1124);

     
     //fbEtaEndcapEH
     functionEndcapBetaEcalHcal->FixParameter(0,-0.0366279);
     functionEndcapBetaEcalHcal->FixParameter(1,-0.20907);
     functionEndcapBetaEcalHcal->FixParameter(2,102.543);
